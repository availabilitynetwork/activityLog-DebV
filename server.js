...
app.post('/api/participant', async (req, res) => {
    ...
    try {
        const result = await pool.query(
            'INSERT INTO participants (email, first_name, last_name, phone, registration_date) VALUES ($1, $2, $3, $4, NOW()) RETURNING participant_id, registration_date;',
...
app.post('/api/activities', async (req, res) => {
    ...
    try {
        // Assuming file_id, upload_date, and activity_id are generated by the server
        const result = await pool.query(
            'INSERT INTO activities (participant_id, activity_type, description, case_notes, billable_hours) VALUES ($1, $2, $3, $4, $5) RETURNING activity_id, file_id, upload_date;',
